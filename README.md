# Events Catalog
Events Catalog is an application that provides a list of events under a variety of events organizers as well as provide a user registration and authentication system. Registered users will have the ability to post, edit and delete their own items. 
...
Using the terminal, change directory to oauth (**cd events-catalog**), then type **vagrant up** to launch your virtual machine.


## Running the Events Catalog App
